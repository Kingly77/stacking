...
savUnits.init({
    ...
    saveID: DataTypes.STRING(15),
    comps: DataTypes.INTEGER , chips: DataTypes.INTEGER , boards: DataTypes.INTEGER , cpus: DataTypes.INTEGER,
    compsEx: DataTypes.INTEGER ,chipsEx: DataTypes.INTEGER,boardsEx: DataTypes.INTEGER, cpusEx: DataTypes.INTEGER,
